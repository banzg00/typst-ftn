...
У овом раду генерисање се заснива на Jinja2 шаблонском механизму, интегрисаном са TextX екосистемом путем библиотеке `textx-jinja`. Овај приступ омогућава да једна BPML спецификација резултира комплетном backend и frontend апликацијом, при чему су детаљи генерисања описани у четвртом поглављу.
