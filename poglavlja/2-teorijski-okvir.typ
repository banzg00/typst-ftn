...
Код интерпретативног приступа, процесни модел се чува у бази података или конфигурационом фајлу и тумачи током извршавања од стране специјализованог engine механизма. Workflow engine чита дефиницију процеса, одређује тренутно стање, евалуира услове и покреће одговарајуће активности — све то у runtime-у, без компилације модела у изворни код.
