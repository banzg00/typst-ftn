...
Слој генерације кода реализован је кроз два генератора, Spring Boot backend генератор и React frontend генератор. Оба генератора заснована су на Jinja2 шаблонском механизму. Детаљан опис механизма генерације и структуре генерисаних система дат је у четвртом поглављу.
...
Након синтаксне анализе, над парсираним моделом извршава се статичка семантичка провјера. Ова фаза представља критичну баријеру између спецификације и генерације кода. Она спречава да модел са логичким грешкама буде трансформисан у некоректан изворни код.
...
На слици @fig:stintaksno-bojenje приказано је синтаксно бојење BPML фајла у VSCode едитору, што илуструје различите категорије лексичких елемената и њихову визуелну репрезентацију.

#figure(image("../slike/sintaksno-bojenje-bpml-fajla-u-vscode-editoru.png", width: auto), caption: [
  Синтаксно бојење BPML фајла у VSCode едитору
...
Метамодел BPML (слика @fig:uml-bpml-dijagram) језика дефинише формалне односе између елемената и представља основу за семантичку анализу и изградњу контекста за генерацију кода.
