...
- аутоматском провјером семантичке исправности,
...
У раду је примијењен приступ заснован на моделом вођеном развоју (енг. Model-Driven Development – MDD). Граматика језика дефинисана је употребом TextX метајезика, који омогућава генерисање метамодела и апстрактног синтаксног стабла на основу текстуалне спецификације @dejanovic2017textx.
...
У шестом поглављу представљена је валидација система на конкретним примјерима, као и анализа предности и ограничења приступа.
